...
pub(crate) struct WracGainAudioProcessor {
    ...
    // Gain itself does not use the channel count; this field only demonstrates the
    // pattern of snapshotting the layout at activate time and storing it as a field.
